...
namespace DAXEditorControl.BracketRenderer
{
  ...
  public class BracketHighlightRenderer : IBackgroundRenderer
  {
    ...
    public static readonly Color DefaultBackground = Color.FromArgb(100, 255, 200, 0);
    public static readonly Color DefaultBorder = Color.FromArgb(128, 255, 0, 0);
    public static readonly Color InvalidBackground = Color.FromArgb(100, 255, 90, 90);
