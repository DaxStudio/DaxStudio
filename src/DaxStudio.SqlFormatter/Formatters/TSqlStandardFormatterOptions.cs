    ...
    public class TSqlStandardFormatterOptions
    {
        ...
        public TSqlStandardFormatterOptions(string serializedString) : this() {
            ...
            foreach (string kvp in serializedString.Split(','))
            {
                ...
                else if (key == "BreakBeforeJoin") BreakBeforeJoin = Convert.ToBoolean(value);
        ...
        { 
            ...
            if (BreakBeforeJoin != _defaultOptions.BreakBeforeJoin) overrides.Add("BreakBeforeJoin", BreakBeforeJoin.ToString());
        ...
        public bool BreakBeforeJoin { get; set; }
