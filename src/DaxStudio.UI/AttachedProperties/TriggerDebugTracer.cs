...
namespace DaxStudio.UI.AttachedProperties
{
    ...
    // Example:
    // <Trigger my:TriggerDebugTracer.TriggerName="BoldWhenMouseIsOver"  
    //          my:TriggerDebugTracer.TraceEnabled="True"  
    ...
    // As this works on anything that inherits from TriggerBase, it will also work on <MultiTrigger>.
        ...
        /// </summary>
        public static class TriggerDebugTracer
        {
            static TriggerDebugTracer()
            {
