...
namespace DaxStudio.UI.Model
{
    public static class QueryBuilder
    {
        ...
        public static string FilterExpressionTreatAs(QueryBuilderFilter filter,bool autoGenerated)
        {
            ...
            var formattedVal = FormattedValue(filter, () => filter.FilterValue,autoGenerated, ref prefix);
        ...
        public static string FilterExpressionBasic(QueryBuilderFilter filter,bool autoGenerated)
        {
            ...
            switch (filter.FilterType)
            {
                ...
                case FilterType.Between:
                    var formattedVal2 = FormattedValue(filter, () => filter.FilterValue2,autoGenerated, ref prefix);
        ...
        public static string FormattedValue(QueryBuilderFilter filter, Func<string> valueFunc, bool autoGenerated, ref string prefix)
        {
