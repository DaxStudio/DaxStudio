...
namespace DaxStudio.UI.Behaviours
{
    ...
    { 
        ...
        {
            private readonly double _margin = 25;
            ...
            public ListViewResizeBehavior(ListView element)
            {
                ...
                _margin = SystemParameters.VerticalScrollBarWidth + 10;
            ...
            { if(_element.Items.Count > 0) _element.ScrollIntoView(_element.Items[_element.Items.Count-1]); }
            */
