...
namespace DaxStudio.UI.Interfaces
{
    public interface IMetadataProvider
    {
        ...
        Task UpdateColumnBasicStatsAsync(ADOTabularColumn column);
        Task<ICollection<string>> GetColumnSampleData(ADOTabularColumn column, int sampleSize);
        ...
        DependentObjects FindDependentObjects(string measureName);
