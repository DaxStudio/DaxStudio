...
/* END QUERY BUILDER */".Replace("\r","");
        ...
        public void TestColumnsAndFiltersQuery()
        {
            ...
            filters.Add(new QueryBuilderFilter(MockColumn.Create("Gender", "'Customer'[Gender]", typeof(string), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.Is, FilterValue = "M"  });
            filters.Add(new QueryBuilderFilter(MockColumn.Create("Color", "'Product'[Color]", typeof(string), ADOTabularObjectType.Column),modelCaps) { FilterType = FilterType.Is, FilterValue = "Red" });
...
/* END QUERY BUILDER */".Replace("\r", "");
        ...
        public void TestColumnsIsNotFilterQuery()
        {
            ...
            filters.Add(new QueryBuilderFilter(MockColumn.Create("Gender", "'Customer'[Gender]", typeof(string), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.IsNot, FilterValue = "M" });
...
/* END QUERY BUILDER */".Replace("\r", "");
        ...
        public void TestNumericFilterQuery()
        {
            ...
            filters.Add(new QueryBuilderFilter(MockColumn.Create("Number of Children", "'Customer'[Number of Children]", typeof(int), ADOTabularObjectType.Column),modelCaps) { FilterType = FilterType.Is, FilterValue = "2" });
...
/* END QUERY BUILDER */".Replace("\r", "");
        ...
        public void TestNumericFilterTypesQuery()
        {
            ...
            filters.Add(new QueryBuilderFilter(MockColumn.Create("Number 1", "'Customer'[Number1]", typeof(int), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.GreaterThan, FilterValue = "1" });
            filters.Add(new QueryBuilderFilter(MockColumn.Create("Number 2", "'Customer'[Number2]", typeof(int), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.GreaterThanOrEqual, FilterValue = "2" });
            filters.Add(new QueryBuilderFilter(MockColumn.Create("Number 3", "'Customer'[Number3]", typeof(int), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.LessThan, FilterValue = "3" });
            filters.Add(new QueryBuilderFilter(MockColumn.Create("Number 4", "'Customer'[Number4]", typeof(int), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.LessThanOrEqual, FilterValue = "4" });
...
/* END QUERY BUILDER */".Replace("\r", "");
        ...
        public void TestStringFilterTypesQuery()
        {
            ...
            filters.Add(new QueryBuilderFilter(MockColumn.Create("String 1", "'Customer'[String1]", typeof(string), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.Contains, FilterValue = "ABC" });
            filters.Add(new QueryBuilderFilter(MockColumn.Create("String 2", "'Customer'[String2]", typeof(string), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.DoesNotContain, FilterValue = "DEF" });
            filters.Add(new QueryBuilderFilter(MockColumn.Create("String 3", "'Customer'[String3]", typeof(string), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.StartsWith, FilterValue = "GHI" });
            filters.Add(new QueryBuilderFilter(MockColumn.Create("String 4", "'Customer'[String4]", typeof(string), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.DoesNotStartWith, FilterValue = "JKL" });
...
/* END QUERY BUILDER */".Replace("\r", "");
        ...
        public void TestBetweenNumbersFilterTypesQuery()
        {
            ...
            filters.Add(new QueryBuilderFilter(MockColumn.Create("Number 1", "'Customer'[Number1]", typeof(long), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.Between, FilterValue = "2", FilterValue2 = "5" });
...
/* END QUERY BUILDER */".Replace("\r", "");
        ...
        public void TestBlankFilterTypesQuery()
        {
            ...
            filters.Add(new QueryBuilderFilter(MockColumn.Create("String 1", "'Customer'[String1]", typeof(string), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.IsBlank, FilterValue = "" });
            filters.Add(new QueryBuilderFilter(MockColumn.Create("String 2", "'Customer'[String2]", typeof(string), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.IsNotBlank, FilterValue = "" });
...
/* END QUERY BUILDER */".Replace("\r", "");
        ...
        public void TestDateFilterQuery()
        {
            ...
            filters.Add(new QueryBuilderFilter(MockColumn.Create("Date 1", "'Customer'[Birth Date]", typeof(DateTime), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.Is, FilterValue = "2019-11-24" });
...
/* END QUERY BUILDER */".Replace("\r", "");
        ...
        public void TestInvalidDateFilterQuery()
        {
            ...
            filters.Add(new QueryBuilderFilter(MockColumn.Create("Date 1", "'Customer'[Birth Date]", typeof(DateTime), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.Is, FilterValue = "24/24/2019" });
...
/* END QUERY BUILDER */".Replace("\r", "");
        ...
        public void TestTreatAsStringFilterQuery()
        {
            ...
            filters.Add(new QueryBuilderFilter(MockColumn.Create("String 1", "'Customer'[String1]", typeof(string), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.Is, FilterValue = "ABC" });
...
/* END QUERY BUILDER */".Replace("\r", "");
        ...
        public void TestTreatAsNumberFilterQuery()
        {
            ...
            filters.Add(new QueryBuilderFilter(MockColumn.Create("Number 1", "'Customer'[Number 1]", typeof(long), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.Is, FilterValue = "123" });
...
/* END QUERY BUILDER */".Replace("\r", "");
        ...
        public void TestInListFilterQuery()
        {
            ...
            filters.Add(new QueryBuilderFilter(MockColumn.Create("String 1", "'Customer'[String 1]", typeof(string), ADOTabularObjectType.Column), modelCaps) { FilterType = FilterType.In, FilterValue = "red\ngreen\nblue" });
...
/* END QUERY BUILDER */".Replace("\r", "");
        ...
        public void TestNotInListFilterQuery()
        {
            ...
            filters.Add(new QueryBuilderFilter(filterCol, modelCaps) { FilterType = FilterType.NotIn, FilterValue = "red\ngreen\nblue" });
