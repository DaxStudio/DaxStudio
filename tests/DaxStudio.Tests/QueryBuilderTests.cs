...
// END QUERY BUILDER".Replace("\r", "");
        ...
        public void TestTreatAsStringFilterQuery()
        {
            ...
            fils.Add(new QueryBuilderFilter(MockColumn.Create("String 1", "'Customer'[String1]", typeof(string), ADOTabularObjectType.Column)) { FilterType = UI.Enums.FilterType.Is, FilterValue = "ABC" });
...
// END QUERY BUILDER".Replace("\r", "");
        ...
        public void TestTreatAsNumberFilterQuery()
        {
            ...
            fils.Add(new QueryBuilderFilter(MockColumn.Create("Number 1", "'Customer'[Number 1]", typeof(long), ADOTabularObjectType.Column)) { FilterType = UI.Enums.FilterType.Is, FilterValue = "123" });
